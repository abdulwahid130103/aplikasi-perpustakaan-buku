...
class anggotaAjaxController extends Controller
{
    ...
    {
        $data = User::with(['peminjaman','keranjang','log_aktivitas_anggota','log_aktivitas_petugas','comment','saran'])->where('role', 'anggota')->latest()->get();
    ...
    public function viewAnggota(){
        return view('backend.anggota.data');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($validasi->fails()){
            ...
            $data["role"] = "anggota";
            User::create($data);
            return response()->json([ "success" => "Berhasil menyimpan data anggota"]);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validasi->fails()){
            ...
            return response()->json([ "success" => "Berhasil mengupdate data anggota"]);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success' => "berhasil menghapus data anggota"]);
    }
}
