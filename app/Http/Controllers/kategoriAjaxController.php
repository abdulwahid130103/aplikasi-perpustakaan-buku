...
class kategoriAjaxController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validasi->fails()){
            ...
            return response()->json([ "success" => "Berhasil menyimpan data kategori"]);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validasi->fails()) {
            ...
            return response()->json([ "success" => "Berhasil mengupdate data kategori"]);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success' => "berhasil menghapus data kategori"]);
    }
}
