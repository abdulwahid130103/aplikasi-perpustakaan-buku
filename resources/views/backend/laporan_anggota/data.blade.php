...
<div class="container-fluid py-4">
    ...
    <a href="{{ route('excelAnggota') }}" class="btn btn-success tombol-tambah" style="padding:10px 15px; background:#16a085;" ><ion-icon style="color:#fff !important; font-size:20px; transform:translateY(2px);" name="download-outline"></ion-icon> Excell</a>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#myTable').DataTable({
          ...
          ajax: "{{ url('admin/laporanAnggotaAjax') }}",
          columns: [
